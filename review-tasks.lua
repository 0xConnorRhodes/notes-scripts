...
-- 1. use fzf to select which folder to review (default to tasks) but then hold, done, etc, also allow selecting by tag and rg over files to build relevant list
-- 2. prompt user for filing action (done, undone, hold etc)
-- 2. take potential multi-selection and iterate over files moving to the correct location
